...
const MUST_EXCLUDE_JOBS = [
  ...
  // 2026-07-15 ユーザー方針で追加除外（派遣/人材紹介・ホテル運営・デリ小売。isNonFoodJob で弾く）
  ...
  '株式会社エヴァーブルースカイ オープニングスタッフ募集（「地方創生/館山」地域の「食」と人をつなぐ、オープニングホテ…）',
];
...
const total = MUST_EXCLUDE.length + MUST_KEEP.length + MUST_EXCLUDE_JOBS.length + MUST_KEEP_JOBS.length + 2
  + 7 + OPENING_TITLES.length + NOT_OPENING_TITLES.length + 6 + 1 + 2 + 2 + 3;

...
const EXCLUDE_KEYWORDS = [
  ...
  'メンズエステ', 'パチンコ', 'パチスロ', '風俗',
  // 会員制BARを名乗るが求人内容（接客キャスト等）からガールズバー系と判断した個別店舗名
  // （既存の一般キーワードに一致しないため店名で除外。Indeedコネクタ収集分、2026-07-23判断確認済み）
  // 「ももいろ」は一般語（桃色）で誤除外リスクが高いため、正式な店舗名が確認できるまで保留
  'グランヴァレ',
...
const CHAIN_BLOCKLIST = [
  ...
  // 全国チェーンのネットカフェ（飲食店ではない。運営会社名「快活フロンティア」で求人票が
  // 出るケースがあるため両方登録。Indeedコネクタ収集分、2026-07-23判断確認済み）
  '快活CLUB', '快活フロンティア',
